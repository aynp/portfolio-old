...
export default function RootLayout({
  ...
  const meta = {
    title: 'Aryan Pathania - Portfolio',
    description: `Computer Science and Engineering Student`,
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        {/* <meta property="og:url" content={`https://aryanpathania.vercel.app${router.asPath}`} /> */}
        {/* <link rel="canonical" href={`https://aryanpathania.vercel.app${router.asPath}`} /> */}
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Aryan Pathania" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@aryanpathania03" />
